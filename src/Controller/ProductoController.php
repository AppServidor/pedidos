...
class ProductoController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/mostrar", name="producto_mostrar", methods={"GET","POST"})
     */
    public function mostrarProducto($id){
        $productos = $this->getDoctrine()->getRepository(Producto::class)->findByCategory($id);
        return $this->render('producto/productosCategoria.html.twig', array('productos' => $productos)
        );
    }
}
