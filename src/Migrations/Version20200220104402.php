 ...
 */
final class Version20200220104402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pedidos (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, fecha DATE NOT NULL, enviado INTEGER NOT NULL)');
